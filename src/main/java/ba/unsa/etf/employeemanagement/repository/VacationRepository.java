...
public class VacationRepository {
    ...
    public Long save(Vacation entity) {
        ...
        jdbcTemplate.update(connection -> {
            ...
            if (entity.getEmployeeId() != null) ps.setLong(1, entity.getEmployeeId()); else ps.setNull(1, java.sql.Types.NUMERIC);
            ...
            if (entity.getApprovedBy() != null) ps.setLong(6, entity.getApprovedBy()); else ps.setNull(6, java.sql.Types.NUMERIC);
